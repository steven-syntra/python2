def SplitParagraph( tekst, width ):
    ...
    for cursor in range(len(tekst)):
        ...
        # als de cursor meer dan 'width' karakters ver is (van het begin van de lijn)
        if (cursor - begin_of_line) > width:
